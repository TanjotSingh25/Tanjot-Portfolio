...
function Certificates() {
  const certificates = [
    ...
    },
    {
      ...
      issuer: 'Meta',
      date: '2022',
      description: 'Comprehensive certification in React development and best practices.'
    },
    {
      title: 'JavaScript Algorithms and Data Structures',
      issuer: 'freeCodeCamp',
      date: '2022',
      description: 'Completed 300+ hours of JavaScript programming challenges.'
    }
  ]
  ...
  const extracurriculars = [
    {
      ...
      organization: 'GitHub',
      period: '2021 – Present',
      description: 'Contributed to various open-source projects, including React libraries and developer tools.'
    },
    {
      title: 'Tech Blog Writer',
      organization: 'Personal Blog',
      period: '2020 – Present',
      description: 'Writing technical articles about web development, best practices, and tutorials.'
    },
    {
      title: 'Hackathon Winner',
      organization: 'Local Tech Community',
      period: '2022',
      description: 'Won first place in a 48-hour hackathon with a innovative mobile application.'
    },
    {
      title: 'Mentor',
          ...
          {extracurriculars.map((item, index) => (
            <div key={index} className="extracurricular-item">
              ...
              <div className="extracurricular-content">
                ...
                <p className="extracurricular-organization">{item.organization}</p>
